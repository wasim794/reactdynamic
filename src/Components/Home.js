...
class Home extends Component {
  ...
  handleKeyPress= () =>{
    ...
    fetch("https://carrylush.herokuapp.com/getBannerImages")
      ...
      fetch("http://carrylush.herokuapp.com/getProductImages/17")
        .then(res => res.json())
        .then(
          (result) => {
            console.log(result.data);
    ...
    return (
                ...
                <div className="col-lg-7 col-md-7">
                  <div className="advanced-search">
                    ...
                    <div className="input-group">
                      <input type="text" placeholder="What do you need?" onKeyPress={this.handleKeyPress} />
              ...
              <div className="container">
                <div className="row">
                  <div className="col-lg-5">
                    ...
                    <a href="#"   className="primary-btn" onClick={this.handleClick}>Shop Now</a>
                  </div>
                </div>
        ...
        <div className="banner-section spad">
          <div className="container-fluid">
            <div className="row">
            {this.state.itemstwo.map(item => (
              <div className="col-lg-3">
                <div className="single-banner">
                <img src={item.ImageName} alt={item.ImageType}/>
            ...
            <div className="row">
              <div className="col-lg-8">
                <div className="filter-control">
                  <ul>
                  <ul>
                  {this.state.itemsthree.map(item => (
                    <li>{item.Name}</li>
                    // <li>HandBag</li>
                    // <li>Shoes</li>
                    // <li>Accessories</li>
